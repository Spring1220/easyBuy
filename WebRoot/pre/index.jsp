	...
	<div class="i_bg bg_color">
		<div class="i_ban_bg">
			...
			<div class="inews">
				<div class="news_t">
					<span class="fr"><a
						href="${ctx}/admin/news?action=queryNewsList">更多 ></a></span>新闻资讯
				</div>
				<ul>
					<c:forEach items="${news}" var="temp">
						<li><span>[ 公告 ]</span> <a
							href="${ctx}/admin/news?action=newsDeatil&id=${temp.id}">${temp.title}</a>
						</li>
					</c:forEach>
				</ul>
				<div class="charge_t">
					...
					<div class="fre_ban">
						<div id="imgPlay1">
							<ul class="imgs" id="actor1">
								<li><a href="#"><img
										src="${ctx}/statics/images/fre_r.jpg" width="211" height="286" /></a></li>
								<li><a href="#"><img
										src="${ctx}/statics/images/fre_r.jpg" width="211" height="286" /></a></li>
								<li><a href="#"><img
										src="${ctx}/statics/images/fre_r.jpg" width="211" height="286" /></a></li>
					...
					<ul>
						<c:forEach items="${temp.productList}" var="productVo">
							<li>
								...
								<div class="img">
									<a
										href="${ctx}/Product?action=queryProductDeatil&id=${productVo.id}">
										<img src="${ctx}/files/${productVo.fileName}" width="185"
										height="155" />
									</a>
								</div>
							</li>
